# shaheen.py :- configuration for a dragonfly-based Shaheen supercomputer
...
# Shaheen II has 18 groups: 
# "Overview of the KAUSTs Cray X40 System - Shaheen II" by Bilel Hadri et al.
