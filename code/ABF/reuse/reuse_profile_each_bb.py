...
def main(bb_file,trace_file):
    ...
    for i in range(0,len(bb_table)):
        ...
        with open(b_t_info[2]+"_reuse_profile.dat","w") as f:
            for item in res_sd_psd_i:
                f.write(str(item)+"\n")
    ...
    print "Finished preparing individual reuse_profile for each basic block"
