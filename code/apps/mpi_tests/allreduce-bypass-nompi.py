...
if len(sys.argv) != 4:
    print("Usage: allreduce-bypass-nompi.py total_ranks ranks_per_host data_size ")
    sys.exit(1)

n = int(sys.argv[1])
x = int(sys.argv[2]) 
s = int(sys.argv[3])
print("allreduce-bypass-nompi.py %d %d %d" % (n, x, s))

modeldict = {
    "model_name" : "allreduce-bypass-nompi",
    "sim_time" : 1e9,
    "use_mpi" : False,
