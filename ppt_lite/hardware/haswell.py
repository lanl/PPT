...
#haswell.py 
''' 
  A Simian resource that represents haswell core. It has
...
clockspeed = ( 
        3.50 * 10 ** 9  # next highest clock 3.40 Highest Turbo Clocks  3.90 3.70 
...
# cache_cycles = [4.0, 12.0, 58.0]  # cycles from www.7-cpu.com where they can be found 
