...
#AMDjaguar.py 
''' 
  A Simian resource that represents AMDjaguar core. It has
...
clockspeed = ( 
        2.40 * 10 ** 9  # next highest clock 1.90 Highest Turbo Clocks  2.40 1.90 
...
# cache_cycles = [4.0, 26.0, 0.0]  # cycles from www.7-cpu.com where they can be found 
