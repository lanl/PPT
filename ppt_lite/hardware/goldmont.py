...
#goldmont.py 
''' 
  A Simian resource that represents goldmont core. It has
...
clockspeed = ( 
        2.10 * 10 ** 9  # next highest clock 2.00 Highest Turbo Clocks  2.40 2.00 
...
cache_levels = 2 
cache_sizes = [24 * kb, 1024 * kb]  # bytes 
...
# cache_cycles = [3.0, 17.0, 0.0]  # cycles from www.7-cpu.com where they can be found 
cache_cycles = [3.0, 18.0]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinethroughputs = {  # in seconds 
        ...
        "idiv": 27.500 / clockspeed, 
        "fdiv": 38.000 / clockspeed, 
