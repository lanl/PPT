...
#skylake-X.py 
''' 
  A Simian resource that represents skylake-X core. It has
...
clockspeed = ( 
        5.00 * 10 ** 9  # next highest clock 4.40 Highest Turbo Clocks  5.00 4.50 
...
cache_levels = 3 
cache_sizes = [32 * kb, 256 * kb, 24576 * kb]  # bytes 
...
# cache_cycles = [4.0, 14.0, 79.0]  # cycles from www.7-cpu.com where they can be found 
cache_cycles = [4.0, 14.0, 59.5]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinelatencies = {  # in seconds 
        ...
        "idiv": 68.500 / clockspeed, 
        "fdiv": 15.000 / clockspeed, 
