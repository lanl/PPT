...
#wolfdale.py 
''' 
  A Simian resource that represents wolfdale core. It has
...
clockspeed = ( 
        3.50 * 10 ** 9  # next highest clock 3.33 Highest Turbo Clocks  3.50 3.33 
...
pipelinelatencies = {  # in seconds 
        "iadd": 3.000 / clockspeed, 
        "fadd": 3.000 / clockspeed, 
        "idiv": 55.500 / clockspeed, 
        "fdiv": 13.500 / clockspeed, 
...
pipelinethroughputs = {  # in seconds 
        "iadd": 2.000 / clockspeed, 
        "fadd": 1.000 / clockspeed, 
        "idiv": 55.400 / clockspeed, 
