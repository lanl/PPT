...
#AMDbobcat.py 
''' 
  A Simian resource that represents AMDbobcat core. It has
...
clockspeed = ( 
        1.75 * 10 ** 9  # next highest clock 1.70 Highest Turbo Clocks  1.75 1.70 
...
cache_levels = 2 
cache_sizes = [32 * kb, 512 * kb]  # bytes 
...
# cache_cycles = [3.0, 27.0, 0.0]  # cycles from www.7-cpu.com where they can be found 
cache_cycles = [3.0, 26.0]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinelatencies = {  # in seconds 
        ...
        "idiv": 81.000 / clockspeed, 
        "fdiv": 19.000 / clockspeed, 
        "imul": 7.000 / clockspeed, 
