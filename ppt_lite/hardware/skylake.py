...
#skylake.py 
''' 
  A Simian resource that represents skylake core. It has
...
clockspeed = ( 
        4.30 * 10 ** 9  # next highest clock 4.20 Highest Turbo Clocks  4.50 4.40 
...
# cache_cycles = [4.0, 12.0, 42.0]  # cycles from www.7-cpu.com where they can be found 
