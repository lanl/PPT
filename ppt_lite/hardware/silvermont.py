...
#silvermont.py 
''' 
  A Simian resource that represents silvermont core. It has
...
clockspeed = ( 
        2.41 * 10 ** 9  # next highest clock 2.00 Highest Turbo Clocks  2.67 2.58 
...
# cache_cycles = [3.0, 14.0, 0.0]  # cycles from www.7-cpu.com where they can be found 
cache_cycles = [3.0, 19.0]  # cycles from microarhitechture.pdf from agner fog 
