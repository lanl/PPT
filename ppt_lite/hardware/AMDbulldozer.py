...
#AMDbulldozer.py 
''' 
  A Simian resource that represents AMDbulldozer core. It has
...
clockspeed = ( 
        4.20 * 10 ** 9  # next highest clock 3.90 Highest Turbo Clocks  4.50 4.20 
...
cache_cycles = [3.5, 21.0, 87.0]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinelatencies = {  # in seconds 
        ...
        "idiv": 50.500 / clockspeed, 
        "fdiv": 26.000 / clockspeed, 
...
pipelinethroughputs = {  # in seconds 
        "iadd": 1.000 / clockspeed, 
        "fadd": 0.500 / clockspeed, 
        "idiv": 1.000 / clockspeed, 
        "fdiv": 47.500 / clockspeed, 
        "imul": 11.500 / clockspeed, 
        "fmul": 6.000 / clockspeed, 
        "load": 5.500 / clockspeed, 
        "store": 1.000 / clockspeed, 
        "alu": 4.000 / clockspeed, 
        "br": 1.000 / clockspeed, 
