...
#sandybridge.py 
''' 
  A Simian resource that represents sandybridge core. It has
...
clockspeed = ( 
        3.50 * 10 ** 9  # next highest clock 3.30 Highest Turbo Clocks  4.00 3.90 
...
# cache_cycles = [4.0, 12.0, 27.9]  # cycles from www.7-cpu.com where they can be found 
