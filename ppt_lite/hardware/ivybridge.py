...
#ivybridge.py 
''' 
  A Simian resource that represents ivybridge core. It has
...
clockspeed = ( 
        3.40 * 10 ** 9  # next highest clock 3.20 Highest Turbo Clocks  3.70 3.50 
...
# cache_cycles = [4.0, 5.0, 0.0]  # cycles from www.7-cpu.com where they can be found 
cache_cycles = [0.0, 11.0, 28.0]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinelatencies = {  # in seconds 
        ...
        "idiv": 65.500 / clockspeed, 
        "fdiv": 17.000 / clockspeed, 
        "imul": 3.000 / clockspeed, 
        "fmul": 5.000 / clockspeed, 
        "load": 2.000 / clockspeed, 
        "store": 2.000 / clockspeed, 
        "alu": 2.000 / clockspeed, 
        "br": 0.100 / clockspeed, 
        "unknown": 1.000 / clockspeed, 
} 
pipelinethroughputs = {  # in seconds 
        "iadd": 0.500 / clockspeed, 
        "fadd": 1.000 / clockspeed, 
        "idiv": 57.000 / clockspeed, 
        "fdiv": 13.000 / clockspeed, 
        "imul": 1.000 / clockspeed, 
        "fmul": 1.000 / clockspeed, 
        "load": 1.000 / clockspeed, # changed from 0.500
        "store": 0.500 / clockspeed, 
        "alu": 0.500 / clockspeed, 
        "br": 2.000 / clockspeed, 
        "unknown": 1.000 / clockspeed, 
} 
