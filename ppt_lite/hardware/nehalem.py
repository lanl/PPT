...
#nehalem.py 
''' 
  A Simian resource that represents nehalem core. It has
...
clockspeed = ( 
        2.26 * 10 ** 9  # next highest clock 2.00 Highest Turbo Clocks  2.26 2.00 
...
cache_levels = 3 
cache_sizes = [32 * kb, 32 * kb, 256 * kb]  # bytes 
...
cache_cycles = [0.0, 11.0, 38.0]  # cycles from microarhitechture.pdf from agner fog 
