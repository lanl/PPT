...
#goldmontPlus.py 
''' 
  A Simian resource that represents goldmontPlus core. It has
...
clockspeed = ( 
        2.00 * 10 ** 9  # next highest clock 1.50 Highest Turbo Clocks  3.20 3.10 
...
cache_levels = 2 
cache_sizes = [24 * kb, 4096 * kb]  # bytes 
