...
#AMDsteamroller.py 
''' 
  A Simian resource that represents AMDsteamroller core. It has
...
clockspeed = ( 
        4.10 * 10 ** 9  # next highest clock 3.70 Highest Turbo Clocks  4.10 3.70 
...
cache_levels = 2 
cache_sizes = [16 * kb, 2048 * kb]  # bytes 
...
cache_cycles = [3.5, 19.0]  # cycles from microarhitechture.pdf from agner fog 
