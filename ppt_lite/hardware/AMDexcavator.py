...
#AMDexcavator.py 
''' 
  A Simian resource that represents AMDexcavator core. It has
...
clockspeed = ( 
        3.80 * 10 ** 9  # next highest clock 3.50 Highest Turbo Clocks  4.00 3.80 
...
cache_levels = 2 
cache_sizes = [32 * kb, 1024 * kb]  # bytes 
...
cache_cycles = [3.0, 17.0]  # cycles from microarhitechture.pdf from agner fog 
...
pipelinelatencies = {  # in seconds 
        ...
        "idiv": 44.500 / clockspeed, 
        "fdiv": 23.000 / clockspeed, 
